...
const FeaturesBar = () => {
  return (
    <section className="bg-[#F9F6F0] border-y border-[#DBC3A5]/40 py-10 sm:py-12 relative z-20">
          ...
          {features.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group flex items-start space-x-4 p-3 rounded-lg hover:bg-white/60 transition-colors"
              >
