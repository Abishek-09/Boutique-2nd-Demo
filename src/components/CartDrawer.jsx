            ...
            >
              ...
              <div className="p-6 bg-[#174A43] text-white flex items-center justify-between border-b border-[#DBC3A5]/20">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-xs bg-[#A95732] px-2 py-0.5 rounded-full font-sans text-white font-medium">
                ...
                <div className="flex justify-between items-center mb-1.5 text-[11px] text-[#DBC3A5]">
                  <span>
                    {subtotal >= freeShippingThreshold ? (
                      <span className="text-[#C8906D] font-medium">✓ You qualify for Complimentary Shipping!</span>
                    ) : (
                ...
                {cartItems.length === 0 ? (
                  <div className="text-center py-16">
                    ...
                    <button
                      type="button"
                      onClick={onClose}
                      className="mt-6 px-6 py-2.5 rounded-lg bg-[#174A43] text-white text-xs uppercase tracking-widest font-sans font-medium hover:bg-[#123632]"
                    >
                      Explore Collections
                    </button>
                  </div>
              ...
              {cartItems.length > 0 && (
                <div className="p-6 bg-white border-t border-[#DBC3A5]/40 space-y-4">
                  ...
                  <button
                    type="button"
                    onClick={() => alert('Proceeding to Lumiere Secure Checkout. Thank you for choosing luxury!')}
